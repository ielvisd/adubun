...
- For DIALOGUE:
  ...
  - Write dialogue explicitly in the 'audioNotes' field using format: "Dialogue: [character] in a warm, confident voice with an American accent says: '[text]'"
...
- **VOICE CONSISTENCY:** When a character speaks in multiple scenes, use the EXACT SAME voice description in the audioNotes field across all scenes
  ...
  - ALL subsequent scenes (body, CTA) MUST use the EXACT SAME voice description from the hook scene
  - Format: "Dialogue: [Character] in a warm, confident voice with an American accent says: '[text]'"
  - Example: Hook scene: "Dialogue: The young woman in a warm, confident voice with an American accent says: 'How am I going to finish all of this?'"
  - Example: Body scene: "Dialogue: The same woman in a warm, confident voice with an American accent says: 'Finally, the clarity I need.'"
  - Example: CTA scene: "Dialogue: The same woman in a warm, confident voice with an American accent says: 'Buy now to transform.'"
  - CRITICAL: The voice description "in a warm, confident voice with an American accent" must appear in EVERY scene where dialogue is present
    ...
    "segments": [
      {
        ...
        "audioNotes": "🚨 MANDATORY: This scene MUST include character dialogue. Generate appropriate dialogue that matches the story content and scene purpose. Format: 'Dialogue: [character] in a warm, confident voice with an American accent says: [text]'. If user provided dialogue, use it. If not, generate dialogue that fits the scene context. CRITICAL: The hook scene MUST establish the voice description 'in a warm, confident voice with an American accent'.",
        "startTime": 0,
        "endTime": 6
      },
      {
...
- **VOICE CONSISTENCY:** Extract voice characteristics from the hook scene audioNotes and use the EXACT SAME voice description for each character in all subsequent scenes where they speak. The hook scene MUST establish "in a warm, confident voice with an American accent" and ALL subsequent scenes MUST use the EXACT SAME voice description. Format: "Dialogue: [Character] in a warm, confident voice with an American accent says: '[text]'"

...
- audioNotes: Format as "Dialogue: [character name/description] says: '[actual script text]'" OR "Voiceover: [actual script text to be spoken by off-screen narrator]" OR "Music: [description of music/sound effects]". 
  ...
  🚨🚨🚨 CRITICAL CTA DIALOGUE WORD LIMIT - ABSOLUTE MANDATORY (ZERO TOLERANCE): For CTA segments specifically, any dialogue MUST be EXACTLY 5 words or less. This is a HARD REQUIREMENT with ZERO TOLERANCE. You MUST NEVER generate CTA dialogue with more than 5 words. Before including any dialogue in a CTA segment's audioNotes field, you MUST:
    ...
    5. Examples of INVALID dialogue you MUST NOT generate: 
       ❌ "Purchase now to transform your skin." (7 words - DO NOT GENERATE THIS - it exceeds 5 words)
       ❌ "Buy now to transform your skin overnight!" (8 words - DO NOT GENERATE THIS)
       ❌ "Purchase now to transform your skin." (7 words - DO NOT GENERATE THIS - this exact phrase is FORBIDDEN)
  ...
  - This requirement applies ONLY to CTA segments. Any CTA dialogue exceeding 5 words will cause the storyboard to be REJECTED. You MUST count words BEFORE generating CTA dialogue, not after. If you generate dialogue with more than 5 words, the entire storyboard will be rejected and you will need to regenerate.

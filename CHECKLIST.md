...
- [x] **TASK-029** Update `/api/generate-assets` to use keyframes | _Backend Lead_ | 8h | TASK-023 ✅
...
- [x] **TASK-033** Update `generate.vue` with new steps | _Frontend Lead_ | 10h | TASK-031, 026 ✅

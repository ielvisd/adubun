        ...
        <div v-if="storyboard" class="mb-6">
          ...
          <div class="flex items-center justify-between mb-4 flex-wrap gap-4">
            ...
            >
              ...
              Back to Storyboard (Non-Seamless)
            </UButton>
            ...
            <div class="flex items-center gap-4">
                <UBadge color="purple" size="lg" variant="subtle" class="uppercase">
                Non-Seamless Mode
                </UBadge>
                <div class="text-sm text-gray-600 dark:text-gray-400">
                <span>
                    Creative transitions - First frames only
                </span>
              </div>
            </div>
          </div>
...
const startGeneration = async () => {
  ...
  // CRITICAL: Set seamlessTransition to false for non-seamless mode
  if (storyboard.value.meta) {
    storyboard.value.meta.seamlessTransition = false
  }
  console.log('[Generate] Non-seamless mode: seamlessTransition set to false')

  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 sm:py-12">
    ...
    <UContainer class="max-w-6xl px-4 sm:px-6">
      ...
      <div v-if="loading" class="flex flex-col items-center justify-center py-24">
        <UIcon name="i-heroicons-arrow-path" class="w-16 h-16 text-secondary-500 animate-spin mb-4" />
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Generating Your Story (Creative Transitions)</h2>
          <p class="text-gray-600 dark:text-gray-400 text-center">We're creating your story with independent scene transitions...</p>
...
const proceedToStoryboards = async () => {
  ...
  try {
    ...
    // Navigate to non-seamless storyboards page
    console.log(`[Stories-Seam] Navigating to /storyboards-seam (non-seamless mode)`)
    await router.push('/storyboards-seam')
  } catch (err: any) {

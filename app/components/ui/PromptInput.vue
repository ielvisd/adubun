...
const adTypeOptions = [
  ...
  { label: 'Unboxing Ad', value: 'unboxing', icon: '🎁', placeholder: 'Describe your product packaging and unboxing moment. Include: box design, packaging materials (tissue/foam), and all accessories. Mention hands holding and rotating the product to display all angles. Example: "Premium wireless headphones in matte black box with magnetic closure, wrapped in white tissue paper. Show hands holding and rotating the product to display all angles (front, side, back views). Includes leather carrying case and braided USB-C cable"', description: 'Hands unbox and rotate product showing all angles' },
